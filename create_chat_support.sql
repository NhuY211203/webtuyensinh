-- ============================================
-- TẠO BẢNG CHAT HỖ TRỢ GIỮA NGƯỜI DÙNG VÀ NGƯỜI PHỤ TRÁCH
-- ============================================
-- Chạy lệnh này trong MySQL để tạo bảng chat hỗ trợ
-- Database: ptdh (hoặc tên database của bạn)

USE ptdh;

-- 1. Tạo bảng phòng chat hỗ trợ
...
-- 3. Tạo các index bổ sung để tối ưu truy vấn
...
-- ============================================
-- XONG! Bảng đã được tạo thành công
-- ============================================
-- Kiểm tra bảng đã tạo:
-- SHOW TABLES LIKE '%chat_support%';
-- 
-- Xem cấu trúc bảng:
-- DESCRIBE phong_chat_support;
-- DESCRIBE tin_nhan_support;
